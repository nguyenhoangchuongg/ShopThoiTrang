...
//        int width = getWidth();
//        int height = getHeight();
//        GradientPaint gra = new GradientPaint(0, 0, Color.WHITE, 0, height, new Color(153, 153, 153, 255));
//        g2.setPaint(gra);
//        Path2D.Float f = new Path2D.Float();
//        f.moveTo(10, 0);
//        int controll = height + height;
//        f.curveTo(100, 200, width , controll, width, 100);
//        g2.fill(f);
//    }
